...
public class ProjectsApp {
  ...
  private Integer getdifficulty() {
	  Integer getdifficulty = getIntInput("Enter the project difficulty (1-5)");
	  if (Objects.nonNull(getdifficulty)) {
		  if(getdifficulty < 1 || getdifficulty > 5) {
			  System.out.println(getdifficulty + " is not beween 1 and 5, please enter a number between 1 and 5.");
			  getdifficulty();
		  }
